...
class UNetDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.format == 'image':
            ...
            im = cv2.imread(os.path.join(self.im_folder_path, im_name), cv2.IMREAD_GRAYSCALE)
            mask = cv2.imread(os.path.join(self.mask_folder_path, im_name), cv2.IMREAD_GRAYSCALE)
            # convert bgr to rgb
...
if __name__ == '__main__':
    torch.manual_seed(0)
    im_folder_path = '/home/zli85/work/research/oec/cloud_detection_model/320/train/subscenes'
    mask_folder_path = '/home/zli85/work/research/oec/cloud_detection_model/320/train/masks'
